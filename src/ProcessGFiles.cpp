...
std::map<std::string, std::string> ProcessGFiles::processGFile(const fs::path& file_path) {
    ...
    try {
        ...
        string title_command = "/Users/quhuigang/wkspaces/Capstone_CAD/brlcad/build/bin/mged -c " + file_path.string() + " title";
        ...
        string tops_command = "/Users/quhuigang/wkspaces/Capstone_CAD/brlcad/build/bin/mged -c " + file_path.string() + " tops";
        ...
        string rt_command_template = "/Users/quhuigang/wkspaces/Capstone_CAD/brlcad/build/bin/rt -s2048 -o " + png_file + " " + file_path.string() + " ";
