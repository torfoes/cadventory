...
std::map<std::string, std::string> ProcessGFiles::processGFile(const fs::path& file_path) {
    ...
    try {
        ...
        string title_command = "mged -c " + file_path.string() + " title";
        ...
        string tops_command = "mged -c " + file_path.string() + " tops";
        ...
        string rt_command_template = "rt -s2048 -o " + png_file + " " + file_path.string() + " ";
