...
ProgressWindow::ProgressWindow(int totalFiles, QWidget *parent)
    : QWidget(parent), totalFiles(totalFiles), filesProcessed(0) {
...
void ProgressWindow::updateProgress() {
  ...
  label->setText(
      QString("Processed %1 of %2 files").arg(filesProcessed).arg(totalFiles));
